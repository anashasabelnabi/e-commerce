        ...
        <div class="row s_product_inner">
            <div class="col-lg-5">
                <div class="product_slider_img">
                    <div id="vertical">
                        <div data-thumb="<?= $model->image_base_url.$model->image_path?>">
                            <img src="<?= $model->image_base_url.$model->image_path?>" />
                        </div>
                        <?php foreach ($gallery as $gallery){?>
                        <div data-thumb="<?= $gallery->base_url.$gallery->path?>">
                            <img src="<?= $gallery->base_url.$gallery->path?>" />
                        </div>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    <ul class="list">
                        <li>
                            <a class="active" href="#">
                                <span>Category</span> : <?= $model->category0->title?></a>
                        </li>
                        <li>
