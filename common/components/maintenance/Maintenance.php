...
class Maintenance extends Component implements BootstrapInterface
{
     ...
     * @var string
     */
    public $maintenanceLayout = '@common/components/maintenance/views/layouts/main__.php';
    /**
     * @var string
     */
    public $maintenanceView = '@common/components/maintenance/views/maintenance/index__.php';
    /**
     * @var string
     */
